...
export default function DashboardTopbar() {
  ...
  return (
    <header
      className="h-[60px] border-b border-[#2a2a2a] flex items-center justify-between px-8 sticky top-0 z-10"
    ...
    >
      <div className="flex items-center gap-2 text-[13.5px] text-[#a3a3a3]">
        <span>NoShow</span>
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="text-[#4a4a4a]">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <Link
          ...
          className="inline-flex items-center gap-1.5 bg-[#e8502a] text-white h-9 px-3.5 rounded-lg text-[13.5px] font-medium hover:bg-[#ff6a3d] transition-colors shadow-[0_6px_16px_-6px_rgba(232,80,42,0.5)] ml-1"
        >
